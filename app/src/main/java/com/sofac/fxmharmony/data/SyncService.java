...
import com.sofac.fxmharmony.util.AndroidComponentUtil;
import com.sofac.fxmharmony.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        FxmHarmonyApplication.get(this).getComponent().inject(this);
    }
